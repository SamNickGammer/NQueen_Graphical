...
function queen(id) {
  ...
  queenPiece.style.background = 'url(queen.svg)';
  queenPiece.style.backgroundSize = 'cover';
...
function checkForChecks(i1, j1, check) {
  for (var i = 0; i < rows; i++) {
    for (var j = 0; j < rows; j++) {
      ...
      tempSquareRow.style.backgroundColor = 'red';
      tempSquareColumn.style.backgroundColor = 'red';
    }
  }
}
